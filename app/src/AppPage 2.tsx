...
const AppPage = () => {
  ...
  const [educationEntries, setEducationEntries] = useState<
    Omit<EducationEntry, "userProfileId">[]
  >([]);
  const [experienceEntries, setExperienceEntries] = useState<
    Omit<ExperienceEntry, "userProfileId">[]
  >([]);
  ...
  const handleEditSave = async (newContent: string) => {
    ...
    try {
      ...
      alert(
        "Error saving document: " + (error.message || "Something went wrong.")
      );
    }
  };
  ...
  const [isDetailCustomizerVisible, setIsDetailCustomizerVisible] =
  ...
  return (
    <div className="mx-auto flex max-w-6xl mobile-break:min-w-[860px] min-w-full flex-col gap-6 p-4 md:p-6 2xl:p-10">
      <ManageSectionsPanel
      ...
      <div className="template-break:w-full mobile-break:w-[800px] w-320 template-break:mx-0 mx-auto">
        <AccordionLayout
      ...
      <div className="flex template-break:hidden flex-col mb-6 items-center px-4">
        <div style={{ height: "3px" }} />
        {/* Container that matches resume width - responsive */}
            ...
            <div className="flex gap-4 w-full h-[80px]">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <span className="mobile-break:inline hidden">
                    Manage Sections
                  </span>
                </button>
              </div>

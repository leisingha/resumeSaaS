  ...
  if (variant === 'linear') {
    return (
      <div className={cn('w-full flex flex-col gap-1', className)}>
        <div className='relative w-full bg-gray-700/50 rounded-full overflow-hidden' style={{ height: thickness }}>
          <motion.div
        ...
        {showLabel && <div className='text-sm text-gray-300 font-medium self-end'>{Math.round(percentage)}%</div>}
      </div>
    );
  }
